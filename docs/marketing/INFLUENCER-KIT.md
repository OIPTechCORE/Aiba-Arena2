# AIBA Arena — Influencer Kit

**For:** All categories of influencers (crypto, gaming, trading, casual, NFT, community)  
**Goal:** Ready-made, customizable materials for promotion.
...
AIBA Arena — Telegram Mini App. Play-to-earn, guild wars, tournaments.

{{APP_URL}}?ref={{REF_CODE}}

#AIBArena #PlayToEarn #TON #Telegram
```
...
Earn NEUR & AIBA. Withdraw on TON. Guild wars, tournaments, global boss raids — all in Telegram.

Link in bio. Use code {{REF_CODE}} for bonus.

#AIBArena #PlayToEarn #TON #Telegram #CryptoGame
```
...
✅ Own AI brokers (INT, SPD, RISK)
✅ Battle in 5 arenas
✅ Earn AIBA → withdraw on TON
✅ Referrals: 10 refs = 2×, 100 = 5×

Play: {{APP_URL}}?ref={{REF_CODE}}
```
...
- Own AI brokers, compete in arenas (prediction, simulation, arbitrage, guild wars)
- Earn NEUR & AIBA; withdraw AIBA on TON
- Guilds, tournaments, global boss, car/bike racing, referrals
...
3. Arenas: 5 modes
4. Rewards: NEUR, AIBA, Stars
5. Extra: Referrals, guilds, tournaments
6. CTA: Link + code
...
- Use `?ref=CODE` in all links
- Replace `CODE` with influencer-assigned code
- Track via `/api/referrals/me` and leaderboard
