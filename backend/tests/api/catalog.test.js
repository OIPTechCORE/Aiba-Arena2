...
test(
    'GET /api/marketplace/system-brokers returns array of brokers with id, name, priceAiba',
    withServer(getApp(), async (port) => {
...
test(
    'GET /api/car-racing/system-cars returns array of cars with id, name, priceAiba',
    withServer(getApp(), async (port) => {
...
test(
    'GET /api/bike-racing/system-bikes returns array of bikes with id, name, priceAiba',
    withServer(getApp(), async (port) => {
