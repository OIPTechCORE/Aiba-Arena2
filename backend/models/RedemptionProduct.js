...
const RedemptionProductSchema = new mongoose.Schema(
    {
        ...
        codeValidityDays: { type: Number, default: 0 },
        partnerWebhookSecret: { type: String, default: '', trim: true },
        eligibilityMinAiba: { type: Number, default: 0 },
        eligibilityMinNeur: { type: Number, default: 0 },
        eligibilityCourseId: { type: String, default: '', trim: true },
        schoolId: { type: mongoose.Schema.Types.ObjectId, ref: 'School', default: null, index: true },
        // P4 — Partner dashboard: API key for read-only access to this product's redemptions
        partnerApiKey: { type: String, default: '', trim: true, index: true },
